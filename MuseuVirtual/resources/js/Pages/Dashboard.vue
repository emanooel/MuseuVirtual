...
<template>
  ...
  <div class="max-w-7xl mx-auto py-10 px-4 bg-gray-900 min-h-screen">
      ...
      >
        Você tem <strong>{{ fotosSemLigacao }}</strong> foto(s) sem ligação com
        rochas, minerais ou jazidas.
      ...
      <div class="bg-gray-800 rounded-lg shadow p-6">
        ...
        <div v-if="atividades.length === 0" class="text-gray-400 text-center py-8">
