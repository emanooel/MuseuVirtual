...
<body class="bg-[#363C27]">
    ...
    <h1 class="font-[arial] pt-40 font-bold text-[70px] text-center text-[#F1EEDD]">Museu Virtual</h1>
    <h2 class="text-center text-[15px] font-[arial] text-[#F1EEDD]">Bem-vindo ao Museu Virtual das Rochas, um <br>espaço
    ...
    <figure class="w-100 mt-10">
        <img class="w-full" src="/assets/img/image 1.png" alt="Imagem de uma jazida ">
    </figure>

    <div class="flex justify-center mr-60 pt-40">
        <h2
            class="font-[arial] font-bold text-[70px] bg-gradient-to-b from-[#F1EEDD] to-[#363C27] bg-clip-text text-transparent">
            Explore</h2>
    </div>
