    ...
    <main id="resultados-container" class="max-w-7xl mx-auto px-4 py-6 bg-white rounded shadow text-black">
        @if(isset($termo))
            <div class="flex justify-between items-center mb-6">
                ...
                <button onclick="document.getElementById('resultados-container').style.display='none'" class="text-sm text-red-600 hover:underline">
                    Fechar tudo
                </button>
            </div>
                    ...
                    <div class="mb-6">
                        ...
                        <ul class="list-disc list-inside">
                            @foreach($minerais as $mineral)
                                <li>
                                    <a href="{{ route('minerais.show', $mineral->id) }}" class="text-blue-600 hover:underline">
                                        {{ $mineral->nome }}
                                    </a>
                                </li>
                            @endforeach
                    ...
                    <div class="mb-6">
                        ...
                        <ul class="list-disc list-inside">
                            @foreach($rochas as $rocha)
                                <li>
                                    <a href="{{ route('site.rochas.show', $rocha->id) }}" class="text-blue-600 hover:underline">
                                        {{ $rocha->nome }}
                                    </a>
                                </li>
                            @endforeach
                    ...
                    <div class="mb-6">
                        ...
                        <ul class="list-disc list-inside">
                            @foreach($jazidas as $jazida)
                                <li>
                                    <a href="{{ route('jazidas.show', $jazida->id) }}" class="text-blue-600 hover:underline">
                                        {{ $jazida->localizacao }}
                                    </a>
                                </li>
                            @endforeach
